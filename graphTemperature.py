...
tsv_data = pd.read_csv("SystemTemperature.tsv", sep='\t')
...
fig.savefig('PeakTemperature.png', format='png', dpi=300, bbox_inches='tight')
fig.savefig('PeakTemperature.eps', format='eps', bbox_inches='tight')

with open("ThermalStatistics.csv", "w") as TSfile:
